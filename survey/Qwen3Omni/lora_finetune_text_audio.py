"""
Qwen3-Omni LoRA ファインチューニング (Text-Audio)
====================================================
...
★ Qwen2.5-Omni との主な違い:
    ...
    - Audio Encoder: AuT (Audio Transformer, 650M, 12.5Hz)
      Qwen2.5-Omni は Whisper-large-v3 (25Hz)
...
SAMPLE_RATE = 16000  # Qwen3-Omni の音声サンプリングレート
...
class TextAudioSFTDataset(Dataset):
    ...
    ★ Qwen2.5-Omni との違い:
        ...
        - Audio Encoder: AuT (12.5Hz) vs Whisper (25Hz)
          → 同じ音声でもトークン数が約半分に (VRAM消費軽減)
        - AuT は Conv2D ×3 (8倍ダウンサンプリング) vs Conv1D ×2 (4倍)
    """
...
def parse_args():
    parser = argparse.ArgumentParser(description="Qwen3-Omni Text-Audio LoRA Fine-tuning")
    ...
    parser.add_argument("--batch_size", type=int, default=1,
                        help="MoE + 音声データはVRAM消費が大きいため1推奨")
